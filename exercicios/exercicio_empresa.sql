/* Otimisar a QUERY com esse comando */
SELECT COUNT(*) as pessoas, departamento FROM funcionarios 
...
WHERE sexo = 'Masculino' AND departamento = 'Jardim';
...
/* CRIANTO A TABELA FUNCIONARIOS */
CREATE TABLE funcionarios(
    idFuncuinario INTEGER,
    nome VARCHAR(100),
    email VARCHAR(200),
    sexo VARCHAR(10),
